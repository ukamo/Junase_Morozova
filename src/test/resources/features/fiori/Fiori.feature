...
Feature: Release New Service Order Quotation in application Fiori
  ...
  Scenario Outline: Create New Service Order Quotation
    ...
    Then I assert I am on screen Service Order Quotations in application Fiori
    Then I assert I am on table Solution Quotation: New on screen Service Order Quotations in application Fiori
    And I set value in description field on tab Solution Quotation: New on screen Service Order Quotations in application Fiori
    And I set "10100001" value in soldto party field on tab Solution Quotation: New on screen Service Order Quotations in application Fiori
