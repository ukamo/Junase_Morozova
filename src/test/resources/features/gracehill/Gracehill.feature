...
Feature: Add New Repo Item in application Gracehill
  As a user
  I want to add New Repo Item in application Gracehill
  So that the Repo item is successfully added

  Scenario Outline: Add New Repo Item in application Gracehill
    ...
    Then I assert I am on tab New Repo Item on screen Vision LMS in application Gracehill
